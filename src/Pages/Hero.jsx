    ...
    >
      <div className="max-w-7xl mx-auto w-full flex flex-col-reverse md:flex-row mt-10 md:mt-16 items-center justify-between gap-10 md:gap-16">
        ...
        >
          ...
          {/* Description */}
          <p
            className={`text-sm sm:text-base md:text-[18px] max-w-xl mx-auto md:mx-0 leading-relaxed ${
          ...
          <div className="flex flex-col sm:flex-row items-center md:items-start gap-4 sm:gap-5 pt-4">
            ...
            {/* Download CV */}
            <button
              className={`px-6 sm:px-7 py-2.5 sm:py-3 rounded-full font-semibold shadow-2xl transition-all duration-300 hover:-translate-y-1 ${
                darkMode
            ...
            {/* See My Work */}
            <button
              className={`px-6 sm:px-7 py-2 sm:py-2.5 rounded-full border-2 font-semibold transition-all duration-300 hover:-translate-y-1 ${
                darkMode
                  ? "border-[#5aaacd] text-[#5aaacd] hover:bg-gradient-to-r from-[#0097b2] to-[#0C7779] hover:text-white hover:shadow-2xl"
                  : "border-cyan-700 text-cyan-700 hover:bg-cyan-700 hover:text-white hover:shadow-2xl"
              }`}
            >
              See My Work
            </button>
        ...
        <div className="flex-1 flex justify-center md:mt-0 mt-15 md:justify-end relative w-full max-w-[350px] sm:max-w-[400px] md:max-w-[500px]">
          ...
          {/* Glow behind image */}
          <div
            className={`absolute w-64 sm:w-72 md:w-80 h-64 sm:h-72 md:h-80 rounded-full -z-10 blur-3xl ${
              darkMode ? "bg-teal-600/30" : "bg-cyan-500/20"
            }`}
          ></div>

          {/* Profile Image */}
          <div className="relative w-64 sm:w-72 md:w-80 h-64 sm:h-72 md:h-80 rounded-full overflow-hidden border-4 border-cyan-700 shadow-[0_0_40px_rgba(20,184,166,0.4)] transition-transform duration-500 hover:scale-105">
            <img
              src={F1}
              alt="Fizza"
